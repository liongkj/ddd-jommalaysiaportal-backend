...
namespace JomMalaysia.Core.Interfaces.Repositories
{
    public interface IListingRepository
    {
        ...
        Task<GetAllListingResponse> GetAllListings(CategoryPath cp = null, string type = "all", bool groupBySub = false, string publishStatus = "published", string selectedCity = "");
