...
namespace JomMalaysia.Core.Domain.Enums
{
    public class WorkflowStatusEnum : EnumerationBase
    {
        ...
        public static WorkflowStatusEnum Completed = new WorkflowStatusEnum(3, "Completed".ToLowerInvariant());
        ...
        public static WorkflowStatusEnum NotFound = new WorkflowStatusEnum(404, "NotFound".ToLowerInvariant());
